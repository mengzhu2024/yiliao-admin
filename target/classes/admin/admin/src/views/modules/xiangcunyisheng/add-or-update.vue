        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="诊所信息" prop="zhensuoxinxi">
          <el-input v-model="ruleForm.zhensuoxinxi" 
              placeholder="诊所信息" clearable  :readonly="ro.zhensuoxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="诊所信息" prop="zhensuoxinxi">
              <el-input v-model="ruleForm.zhensuoxinxi" 
                placeholder="诊所信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.touxiang = true;
            continue;
	            	            ...
	            	            if(o=='zhensuoxinxi'){
            this.ruleForm.zhensuoxinxi = obj[o];
	    this.ro.zhensuoxinxi = true;
            continue;
          }
	            	            if(o=='shenfenzheng'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiangcunyisheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiangcunyishengCrossAddOrUpdateFlag = false;
                  this.parent.search();
