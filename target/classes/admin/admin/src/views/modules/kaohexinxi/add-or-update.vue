          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考核情况" prop="kaoheqingkuang">
          <el-input v-model="ruleForm.kaoheqingkuang" 
              placeholder="考核情况" clearable  :readonly="ro.kaoheqingkuang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考核情况" prop="kaoheqingkuang">
              <el-input v-model="ruleForm.kaoheqingkuang" 
                placeholder="考核情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='kaoheqingkuang'){
            this.ruleForm.kaoheqingkuang = obj[o];
	    this.ro.kaoheqingkuang = true;
            continue;
          }
	            	            if(o=='jiangli'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/xiangcunyisheng/zhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    zhanghaoChange () {
      this.$http({
        url: `follow/xiangcunyisheng/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kaohexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaohexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
