          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训项目" prop="peixunxiangmu">
          <el-input v-model="ruleForm.peixunxiangmu" 
              placeholder="培训项目" clearable  :readonly="ro.peixunxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训项目" prop="peixunxiangmu">
              <el-input v-model="ruleForm.peixunxiangmu" 
                placeholder="培训项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训对象" prop="peixunduixiang">
          <el-input v-model="ruleForm.peixunduixiang" 
              placeholder="培训对象" clearable  :readonly="ro.peixunduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训对象" prop="peixunduixiang">
              <el-input v-model="ruleForm.peixunduixiang" 
                placeholder="培训对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mingcheng = true;
            continue;
	            	            ...
	            	            if(o=='peixunxiangmu'){
            this.ruleForm.peixunxiangmu = obj[o];
	    this.ro.peixunxiangmu = true;
            continue;
          }
	            	            if(o=='peixunduixiang'){
            this.ruleForm.peixunduixiang = obj[o];
	    this.ro.peixunduixiang = true;
            continue;
          }
	            	            if(o=='peixunneirong'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xuexipeixun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xuexipeixunCrossAddOrUpdateFlag = false;
                  this.parent.search();
